// Healthcares Tag Lines
// from: http://brandongaille.com/255-examples-catchy-healthcare-slogans-and-taglines/
...
'Your intown health care partner.',
...
function get_random_tagline() {
	index = generate_random_number();
	return quotes[index];
}

$(document).ready(function(){
	$('splash-head').html(get_random_tagline());
	$('splash-subhead').html(get_random_tagline());
});
