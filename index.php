    ...
    <div class="content">
        ...
        <div class="pure-g">
            ...
            <div class="l-box pure-u-1 pure-u-md-1-2 pure-u-lg-1-4">
    			...
    			<a href="http://www.thedoctorstv.com/" target="_blank"><button class="button-xlarge pure-button">Watch Episodes</button></a>
            </div>
            <div class="l-box pure-u-1 pure-u-md-1-2 pure-u-lg-1-4">
                <h3 class="content-subhead">
                    House MD
    			...
    			<a href="https://www.youtube.com/watch?v=FanXU570rYc&list=PLIbKlKr7DpM4QjDdmAV731NPt14u1x_Yu" target="_blank"><button class="button-xlarge pure-button">Watch Episodes</button></a>
            </div>
        </div>
    </div>
